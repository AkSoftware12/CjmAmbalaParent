...
class _LibraryScreenState extends State<LibraryScreen> {
  ...
  Future<void> fetchAssignmentsData(String type, String title, int publishers,
    ...
    final response = await http.get(
      ...
      Uri.parse(
          '${ApiRoutes
              .getTeacherlibrary}?type=$type&publisher=$publishers&supplier=$supplier&title=${textController
              .text}'),
      ...
      body: Column(
        children: [
          SizedBox(
            ...
            child: Material(
              elevation: 5,
              shadowColor: AppColors2.secondary,
              child: ListView(
          ...
          //           colors: [
          //             AppColors2.primary, // Change to your desired colors
          //             Colors.purple,
          //           ],
