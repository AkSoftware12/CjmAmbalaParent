...
import 'student_message_detail_screen.dart';

class StudentSendMsgScreen extends StatefulWidget {
  final int? messageSendPermissionsApp;

  const StudentSendMsgScreen({
    super.key,
    required this.messageSendPermissionsApp,
  });

  @override
  State<StudentSendMsgScreen> createState() => _SendMsgScreenState();
}

class _SendMsgScreenState extends State<StudentSendMsgScreen> {
  ...
  Future<void> fetchMessages() async {
    ...
    try {
      final Uri url = Uri.parse(
        '${ApiRoutes.getStudentMessageSendList}?page=$currentPage',
      );
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => StudentMessageDetailScreen(
              userName: senderName,
